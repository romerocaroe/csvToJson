...
var _default = {
  Query: {
    permissions: (_, {
      ...
      if (!user || !rbac.isAllowed(user.id, _permissions.SECURITY_ROLE_SHOW) && !rbac.isAllowed(user.id, _permissions.SECURITY_ROLE_SHOW_CHILD)) throw new _apolloServerExpress.ForbiddenError("Not Authorized");
