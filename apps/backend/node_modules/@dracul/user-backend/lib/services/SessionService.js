...
exports.updateSession = exports.sessionsByUser = exports.sessionsByOs = exports.sessionsByDeviceType = exports.sessionsByCountry = exports.sessionsByClient = exports.sessionsByCity = exports.createSession = void 0;
...
const createSession = async function (user, req) {
  return new Promise((resolve, reject) => {
    ...
    newSession.save().then(() => {
      ...
      _loggerBackend.DefaultLogger.error('SessionService.createSession ', err);
...
const updateSession = async function (user) {
  if (user != undefined && user.idSession != undefined) {
    _SessionModel.default.findOne({
      ...
      _loggerBackend.DefaultLogger.error('SessionService.updateSession ', err);
    });
  }
};
...
const sessionsByUser = async function (time, unit = 'days') {
  return new Promise((resolve, reject) => {
    _SessionModel.default.aggregate([{
      ...
      if (err) {
        _loggerBackend.DefaultLogger.error('SessionService.sessionsByUser ', err);
      }
...
const sessionsByCountry = async function (time, unit = 'days') {
  return new Promise((resolve, reject) => {
    _SessionModel.default.aggregate([{
      ...
      if (err) {
        _loggerBackend.DefaultLogger.error('SessionService.sessionsByCountry ', err);
      }
...
const sessionsByOs = async function (time, unit = 'days') {
  return new Promise((resolve, reject) => {
    _SessionModel.default.aggregate([{
      ...
      if (err) {
        _loggerBackend.DefaultLogger.error('SessionService.sessionsByOs ', err);
      }
...
const sessionsByDeviceType = async function (time, unit = 'days') {
  return new Promise((resolve, reject) => {
    _SessionModel.default.aggregate([{
      ...
      if (err) {
        _loggerBackend.DefaultLogger.error('SessionService.sessionsByDeviceType ', err);
      }
...
const sessionsByCity = async function (time, unit = 'days') {
  return new Promise((resolve, reject) => {
    _SessionModel.default.aggregate([{
      ...
      if (err) {
        _loggerBackend.DefaultLogger.error('SessionService.sessionsByCity ', err);
      }
...
const sessionsByClient = async function (time, unit = 'days') {
  return new Promise((resolve, reject) => {
    _SessionModel.default.aggregate([{
      ...
      if (err) {
        _loggerBackend.DefaultLogger.error('SessionService.sessionsByClient ', err);
      }
