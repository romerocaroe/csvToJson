  ...
  recovery(to, url, user) {
    return new Promise((resolve, reject) => {
      ...
      email.send({
        ...
        _loggerBackend.DefaultLogger.error('UserEmailManager.recovery ', error);
  ...
  recoveryCode(to, code, user) {
    return new Promise((resolve, reject) => {
      ...
      email.send({
        ...
        _loggerBackend.DefaultLogger.error('UserEmailManager.recoveryCode ', error);
  ...
  activation(to, url, user) {
    return new Promise((resolve, reject) => {
      ...
      email.send({
        ...
        _loggerBackend.DefaultLogger.error('UserEmailManager.activation ', error);
